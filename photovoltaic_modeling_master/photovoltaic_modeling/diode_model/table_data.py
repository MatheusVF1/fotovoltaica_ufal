...
colunas_numericas = ['Radiação', 'Temp_Cel', 'Temp_Amb', 'Tensao_S1_Avg', 'Corrente_S1_Avg', 'Potencia_S1_Avg',
                     'Tensao_S2_Avg', 'Corrente_S2_Avg', 'Potencia_S2_Avg', 'Potencia_FV_Avg', 'Demanda_Avg', 'FP_FV_Avg', 'Tensao_Rede_Avg']
